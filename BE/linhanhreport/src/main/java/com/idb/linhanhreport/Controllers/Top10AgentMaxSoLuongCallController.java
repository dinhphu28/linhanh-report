...
import com.idb.linhanhreport.Services.Top10AgentMaxSoLuongCallService;

@RestController
@CrossOrigin("*")
@RequestMapping("/api/v1/top10agentsmaxnocalls")
public class Top10AgentMaxSoLuongCallController {
    @Autowired
    private Top10AgentMaxSoLuongCallService top10AgentMaxSoLuongCallService;
    ...
    public ResponseEntity<Object> retrieveAllWithFilters(@RequestParam(value = "from", required = true) String from, @RequestParam(value = "to", required = true) String to, @RequestParam(value = "direction", required = true) String direction, @RequestParam(value = "group", required = false) String group, @RequestParam(value = "username", required = false) String username) {
        ...
        List<Top10AgentMaxSoLuongCall> top10AgentMaxSoLuongCalls = top10AgentMaxSoLuongCallService.retrieveAllWithFilters(from, to, direction, group, username);
